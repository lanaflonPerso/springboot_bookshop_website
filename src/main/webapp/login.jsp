...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/style.css">
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/stylefb.css">
        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="${pageContext.request.contextPath}/j_spring_security_check">
              ...
              <input class="btn btn-lg btn-primary btn-block text-uppercase" value="submit" type="submit">
              <hr class="my-4">
            </form>
          </div>
        </div>
